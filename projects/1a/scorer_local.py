...
# Открытие файла с истинными метками
df_true = pd.read_csv(true_path, header=None, index_col=0, names=["id", "true"])

# Открытие файла с предсказанными вероятностями
df_pred = pd.read_csv(pred_path, header=None, index_col=0, names=["id", "pred_0", "pred_1"])

# Проверка соответствия количества записей в файлах
